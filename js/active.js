...
let restaurantLatLng = [27.145751,-13.197090];
...
const deliveryRadius = 5700; // 1000 متر
...
if (selectedLatLng) {
  ...
  const url = "https://wa.me/212621254968?text=" + encodeURIComponent(message);
...
function showCategory(categoryId) {
  ...
  if (selectedSection) {
    ...
    }, 50); // يعطي وقت صغير قبل تطبيق الكلاس للتأثير

    // نحط القسم في وسط الشاشة تقريبا
    ...
    // نخفي العناصر الزائدة داخل القسم
